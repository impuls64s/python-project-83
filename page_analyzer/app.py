from flask import (Flask, render_template, request,
                   flash, get_flashed_messages, url_for, redirect)
from .creator import (add_to_database, data_url, check_in_db,
                      add_to_url_checks, data_all_url_checks,
                      data_all_all_site)
import validators
import os
...
def url_add():
    ...
    return render_template(
        'index.html', messages=messages, data=name_url), 422
